...
use crate::triplestore::sparql::Triplestore;
...
use polars::prelude::{
    col, Expr, IntoLazy, LazyFrame, LiteralValue, Operator, Series,
    UniqueKeepStrategy,
};
use polars::functions::concat_str;
use spargebra::algebra::{Expression, Function as SpargebraFunction};
use std::collections::HashSet;
use polars::export::num::traits::real::Real;
...
pub fn lazy_expression(
    ...
    let lf = match expr {
        ...
        Expression::Or(left, right) => {
            ...
            let mut inner_lf = lazy_expression(left, inner_lf, columns,  &left_context);
            let right_context = context.extension_with(PathEntry::OrRight);
            inner_lf = lazy_expression(right, inner_lf, columns,  &right_context);
            inner_lf = inner_lf
                .with_column(
                    (Expr::BinaryExpr {
        ...
        Expression::UnaryPlus(inner) => {
            ...
            let mut inner_lf =
                lazy_expression(inner, inner_lf, columns,  &plus_context);
            inner_lf = inner_lf
                .with_column(
                    (Expr::BinaryExpr {
        ...
        Expression::UnaryMinus(inner) => {
            ...
            let mut inner_lf =
                lazy_expression(inner, inner_lf, columns,  &minus_context);
            inner_lf = inner_lf
                .with_column(
                    (Expr::BinaryExpr {
                        left: Box::new(Expr::Literal(LiteralValue::Int32(0))),
        ...
        Expression::Not(inner) => {
            ...
            let mut inner_lf = lazy_expression(inner, inner_lf, columns,  &not_context);
            inner_lf = inner_lf
        ...
        Expression::Exists(inner) => {
            ...
            let mut combiner = Triplestore::new();
        ...
        Expression::If(left, middle, right) => {
            ...
            inner_lf = lazy_expression(middle, inner_lf, columns,  &middle_context);
